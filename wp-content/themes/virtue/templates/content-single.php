<?php if(kadence_display_sidebar()) {
  ...
  <div id="content" class="container">
    ...
    <header>
     ...
     <div class="ten_danhmuc"><h2><?php the_title(); ?></h2></div>
...
<!-- Hiển thị bài viết liên quan trong Category -->
...
<?php
...

    {
        ...
        'showposts'=>4, // Số bài viết hiển thị.
...

        {
            ...
            echo '<h3>CÁC BÀI VIẾT KHÁC</h3><ul class="list-news">';
